...
# When Python read a variable name, it reaplaces it
...
age = 16
# Float: any number with a decimal. postive or negative
grade = 98.6
# String: a string of human-readable characters
name = "Jeff"
# numbers in a string are not number, they are letters
favoriteNumber = "69"
...
# Don't forget! If you want to convert a value permanently
